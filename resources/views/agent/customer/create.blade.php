...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
    <h2 class="text-xl font-semibold text-gray-800 mb-6">ユーザー追加</h2>
    <form action="{{ route('agent.customer.store') }}" method="POST">
      ...
      <div class="grid gap-6 mb-6 lg:grid-cols-2">
        ...
        <div>
          ...
          <input type="text" id="initial" name="initial" class="block w-full p-2.5 border border-gray-300 rounded-lg shadow-sm">
        </div>
        <div>
        ...
        <div>
          ...
          <input type="number" id="matching" name="matching" class="block w-full p-2.5 border border-gray-300 rounded-lg shadow-sm" placeholder="5" min="0" max="5" required>
        </div>
        <div>
          <label for="created_at" class="block mb-2 text-sm font-medium text-gray-900">作成日</label>
          <input type="datetime-local" id="created_at" name="created_at" class="block w-full p-2.5 border border-gray-300 rounded-lg shadow-sm" required>
        </div>
        <!-- 新しいフィールド -->
        <div>
          <label for="age" class="block mb-2 text-sm font-medium text-gray-900">年齢</label>
          <input type="number" id="age" name="age" class="block w-full p-2.5 border border-gray-300 rounded-lg shadow-sm">
        </div>
        <div>
          <label for="gender" class="block mb-2 text-sm font-medium text-gray-900">性別</label>
          <input type="text" id="gender" name="gender" class="block w-full p-2.5 border border-gray-300 rounded-lg shadow-sm">
        </div>
        <div>
          <label for="desired_salary_min" class="block mb-2 text-sm font-medium text-gray-900">希望年収（下限）</label>
          <input type="number" id="desired_salary_min" name="desired_salary_min" class="block w-full p-2.5 border border-gray-300 rounded-lg shadow-sm">
        </div>
        <div>
          <label for="desired_salary_max" class="block mb-2 text-sm font-medium text-gray-900">希望年収（上限）</label>
          <input type="number" id="desired_salary_max" name="desired_salary_max" class="block w-full p-2.5 border border-gray-300 rounded-lg shadow-sm">
        </div>
        <div>
          <label for="catch_copy" class="block mb-2 text-sm font-medium text-gray-900">経歴キャッチコピー</label>
          <input type="text" id="catch_copy" name="catch_copy" class="block w-full p-2.5 border border-gray-300 rounded-lg shadow-sm" maxlength="60">
        </div>
        <div>
          <label for="career_description" class="block mb-2 text-sm font-medium text-gray-900">経歴概要</label>
          <input type="text" id="career_description" name="career_description" class="block w-full p-2.5 border border-gray-300 rounded-lg shadow-sm" maxlength="250">
        </div>
        <div>
          <label for="recommendation" class="block mb-2 text-sm font-medium text-gray-900">こんな企業におすすめ</label>
          <textarea id="recommendation" name="recommendation" class="block w-full p-2.5 border border-gray-300 rounded-lg shadow-sm"></textarea>
        </div>
        <div>
          <label for="num_companies_worked" class="block mb-2 text-sm font-medium text-gray-900">経験社数</label>
          <input type="number" id="num_companies_worked" name="num_companies_worked" class="block w-full p-2.5 border border-gray-300 rounded-lg shadow-sm">
        </div>
        <div>
