...
<div id="application-sidebar" class="hs-overlay [--auto-close:lg]
  ...
  <div class="px-8 pt-4">
    <!-- Logo -->
    <img class="w-full rounded-md" src="{{ asset('photo/agent.png') }}" alt="Image Description">
  </div>

  <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
    <ul class="space-y-1.5">
      <li>
        <a class="flex items-center gap-x-3.5 py-2 px-2.5 bg-gray-100 text-sm text-neutral-700 rounded-lg hover:bg-gray-100" href="{{ route('agent.dashboard') }}">
      ...
      <li class="hs-accordion" id="users-accordion">
        <a href="{{ route('agent.customer.index') }}" class="hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-neutral-700 rounded-lg hover:bg-gray-100">
      ...
      <li class="hs-accordion" id="account-accordion">
        <a href="{{ route('agent.messages.index') }}" class="hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-neutral-700 rounded-lg hover:bg-gray-100">
      ...
      <li class="hs-accordion" id="projects-accordion">
        <a href="{{ route('agent.profile') }}" class="hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-neutral-700 rounded-lg hover:bg-gray-100">
