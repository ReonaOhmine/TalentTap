        ...
        function openModal(id) {
            ...
            fetch(`https://freddy.sakura.ne.jp/TalentTap/api/get-candidate/${id}`)
                ...
                .then(data => {
                    ...
                    if (data.gender === '男性') {
                        profilePicture.src = '/TalentTap/photo/boy.png';
                    } else if (data.gender === '女性') {
                        profilePicture.src = '/TalentTap/photo/girl.png';
                    } else {
                        profilePicture.src = '/TalentTap/photo/profile-picture.png';
                    }
    ...
    document.getElementById('confirm-no').onclick = function() {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function fetchCandidates() {
                ...
                fetch('https://freddy.sakura.ne.jp/TalentTap/employer/customer/data')
                    .then(response => {
                        if (!response.ok) {
