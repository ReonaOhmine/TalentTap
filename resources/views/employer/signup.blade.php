  ...
  <div class="p-4 sm:p-7">
    <div class="text-center">
      ...
      <p class="mt-2 text-sm text-gray-600">
        ...
        <a class="text-blue-600 decoration-2 hover:underline font-medium" href="{{ route('employer.login') }}">
          Sign in here
        </a>
      </p>
    </div>
    ...
    <div class="mt-5">
      ...
      <!-- Form -->
      <form method="POST" action="{{ route('employer.signup') }}">
        @csrf
